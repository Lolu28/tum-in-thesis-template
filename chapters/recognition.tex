...
In this section we show the software architecture that lies behind the object recognition system that we created. The system was divided into 5 ROS packages with different responsibilities:
\begin{itemize}
